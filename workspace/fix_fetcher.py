...
def fetch_rss(url, outlet_name, limit=3):
...
mk_items = fetch_rss("https://www.mk.co.kr/rss/30000001", "매일경제", 3)
hk_items = fetch_rss("https://www.hankyung.com/feed/all-news", "한국경제", 10)

print(f"MK items: {len(mk_items)}")
print(f"HK items: {len(hk_items)}")
